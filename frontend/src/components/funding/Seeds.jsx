            ...
            <div className="main-page-content">
              <div className="submain">
                ...
                <div className="investpro">
                  ...
                  <ul>
                    <li>
                      Deeptech firms driven by science and technology;
                  ...
                  <div className="boxes">
                    <div className="subbox">
                      ...
                      <p>
                        ...
                        Entrepreneurship and Enterprise Development Fund"
                        program (BIRAC). The maximum amount of funding available
                        to a single startup will be Rs 30 lakh.
                      </p>
                    ...
                    <div className="subbox">
                      ...
                      <p>
                        ...
                        (SISFS) was established. One start-up would receive up
                        to Rs 20 lakh in grants and up to Rs 50 lakh in
                        compulsory convertible debt (CCD) as financial aid.
                      </p>
                      <button>Learn more</button>
                    </div>
                    <div className="subbox">
                      ...
                      <p>
                        A seed fund administered by the Department of Science
                        and Technology's National Science & Technology
                    ...
                    <div className="subbox">
                      ...
                      <p>
                        A seed fund administered by the Department of Science
                        and Technology's Technology Development Board (TDB). Up
                        to Rs 25 lakh in financial support was given to one
                        startup.
                      </p>
                      <button>Learn more</button>
                    </div>
